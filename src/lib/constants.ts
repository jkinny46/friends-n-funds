 ...
 */
export const APP_NAME = 'Friends n Funds';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION = 'Social circle no-loss gambling';
 ...
 */
export const APP_TAGS = ['social', 'games', 'gambling', 'DeFi'];
 ...
 */
export const APP_BUTTON_TEXT = 'Open FnF';
